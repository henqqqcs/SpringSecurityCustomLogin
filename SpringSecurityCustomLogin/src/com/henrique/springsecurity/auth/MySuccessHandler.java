...
@Component
public class MySuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler implements AuthenticationSuccessHandler {

	private RedirectStrategy redirectStrategy = new DefaultRedirectStrategy();
	private RequestCache requestCache = new HttpSessionRequestCache();
	private static final String DEFAULT_TARGET_URL = "/secured/home";
	private static final String ADMIN_TARGET_URL = "/admin";
	private static final String CART_TARGET_URL = "/secured/payment";
	...
	protected boolean fromCartRequest(HttpServletRequest request) {
		...
		if (previusUrl.contains("payment") || (previusUrl.contains("cart"))) {
			return true;
		}
